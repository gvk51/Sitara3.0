...
static int aic3x_init(struct snd_soc_codec *codec)
{
	...
	/* Unmute the Mic inputs */
	reg = snd_soc_read(codec, MIC3LR_2_LADC_CTRL);
	snd_soc_write(codec, MIC3LR_2_LADC_CTRL, reg & 0xEE);
	reg = snd_soc_read(codec, MIC3LR_2_RADC_CTRL);
	snd_soc_write(codec, MIC3LR_2_RADC_CTRL, reg & 0xEE);
